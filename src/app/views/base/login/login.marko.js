...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/cursonode$1.0.0/src/app/views/base/login/login.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<header class=\"cabecalhoPrincipal\"><div class=\"container\"><div class=\"row align-items-center\"><div class=\"col-4\"><h1 class=\"logo\"><img src=\"/static/images/livros.svg\" alt=\"Livraria\"></h1></div><div class=\"cabecalhoPrincipal-navegacao col-8\"><a href=\"#\" class=\"login\"><i class=\"fas fa-sign-in-alt\"></i>Login</a></div></div></div></header><main class=\"conteudoPrincipal\"><div class=\"container\"><h1>Login</h1><form action=\"/login\" method=\"post\"><div class=\"form-group\"><label for=\"email\">E-mail:</label><input type=\"text\" id=\"email\" name=\"email\" class=\"form-control\"></div><div class=\"form-group\"><label for=\"senha\">Senha:</label><input type=\"password\" id=\"senha\" name=\"senha\" class=\"form-control\"></div><input type=\"submit\" value=\"logar\" class=\"btn btn-block btn-success\"></form></div></main><footer class=\"rodape\"><div class=\"container\"><div class=\"row align-items-center\"><div class=\"col-4\"><img src=\"/static/images/logo-rodape.svg\" class=\"logo-rodape\"></div><div class=\"col-8\"><ul class=\"redesSociais\"><li><a href=\"http://www.facebook.com/\" class=\"compartilhar-facebook\" target=\"_blank\">/teste</a></li><li><a href=\"http://www.twitter.com/\" class=\"compartilhar-twitter\" target=\"_blank\">@teste</a></li></ul></div></div></div></footer>");
...
marko_template.meta = {
    id: "/cursonode$1.0.0/src/app/views/base/login/login.marko",
    tags: [
